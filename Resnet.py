...
X_train = X_train.reshape(9736,1,1,101)
X_test = X_test.reshape(513,1,1,101)
...
def ResNet50(input_shape=(1, 1, 101), classes=16):
...
model.fit(X_train, Y_train, epochs=60, batch_size=2000)
